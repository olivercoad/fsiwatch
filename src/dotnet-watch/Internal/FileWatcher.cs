...
namespace Microsoft.DotNet.Watcher.Internal
{
    public class FileWatcher
    {
        ...
        private readonly bool _usePollingWatcher;

        // public FileWatcher()
        //     : this(NullReporter.Singleton)
        // { }

        public FileWatcher(IReporter reporter, bool usePollingWatcher)
        {
            _reporter = reporter ?? throw new ArgumentNullException(nameof(reporter));
            _usePollingWatcher = usePollingWatcher;
        ...
        private void AddDirectoryWatcher(string directory)
        {
            ...
            var newWatcher = FileWatcherFactory.CreateWatcher(directory, _usePollingWatcher);
